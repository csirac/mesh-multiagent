...
\code{/auto budget <project> <n>} & Set the daily worker ceiling (1--50). \\
...
1--10 ``worthiness score.'' Broadly useful events enter the episodic pool.
...
(1--2 sentences) stored alongside
...
\begin{itemize}[nosep]
  ...
  \item \textbf{Standing digest vs.\ TOC}: The episodic memory TOC
        ...
        search and exact memory handles underneath it.
