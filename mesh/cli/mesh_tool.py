...
def _print_tool_list(registry) -> None:
    ...
    categories = {
        ...
        "Browser": ["browser_session_status", "browser_session_open",
                    "browser_session_close", "browser_goto", "browser_get_url",
                    "browser_snapshot_controls", "browser_read_text", "browser_click",
                    "browser_fill", "browser_type", "browser_press", "browser_select",
                    "browser_back"],
